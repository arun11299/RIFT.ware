...
function(rift_unittest target)
  ...
  set(testArgs ${PROJECT_TOP_DIR}/bin/catchsegv.sh)

  # If ENVSET_ARGS was provided, add envset.sh to the command line with the envset vars
  if(ARGS_ENVSET_ARGS)
    set(testArgs ${testArgs} ${PROJECT_TOP_DIR}/scripts/env/envset.sh ${ARGS_ENVSET_ARGS})
  ...
  add_custom_target(${target}
    ...
    COMMAND ${PROJECT_TOP_DIR}/scripts/env/test_wrapper.sh ${outputDir} ${target} ${testArgs}
