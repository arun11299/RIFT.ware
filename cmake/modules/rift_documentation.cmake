...
function(rift_add_doxygen_target TARGET)
  ...
  add_custom_target(${TARGET}
    ${CMAKE_COMMAND} -E 
    copy ${PROJECT_TOP_DIR}/cmake/modules/doxy_template.cfg 
...
function(rift_asciidoc_to_pdf TARGET)
  ...
  if (EXISTS "/usr/rift/bin/asciidoctor")
    set(asciidoctor "/usr/rift/bin/asciidoctor")
  endif()
  ...
  foreach(asciidoc_file ${ARGS_ASCIIDOC_FILES})
    ...
    add_custom_command(
      ...
      stamp ${PROJECT_TOP_DIR}/cmake/modules/riftio_watermark.pdf
      output ${basename}.pdf
...
function(rift_generate_index_html_head)
  ...
  file(APPEND ${fname} "        Documentation Home\n")
  file(APPEND ${fname} "    </h2>\n")
  file(APPEND ${fname} "    <hr>\n")
  file(APPEND ${fname} "    <a href='arch/pdf'>Architecture Docs (lyx format)</a>\n")
  file(APPEND ${fname} "    <hr>\n")
