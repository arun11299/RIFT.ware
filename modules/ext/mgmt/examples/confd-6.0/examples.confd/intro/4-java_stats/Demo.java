...
public class Demo {
    ...
    public static class StatsCb {
        ...
        public ConfKey getKey(DpTrans trans, ConfObject[] kp, Object obj)
            ...
            ConfObject c;
            //try {
            c =  e.getIPAddress();//new ConfIPv4(e.ip);
            //}
            // catch (ConfException e2) {
            //     throw new DpCallbackException(e2.getMessage());
            // }
            return new ConfKey( new ConfObject[] { c,
        ...
        public ConfValue getElem(DpTrans trans, ConfObject[] kp)  {
            ...
            for (int i = 0; i < entries.size(); i++) {
                ...
                try { confIPv4 = new ConfIPv4(ip);}
                catch (ConfException e2) {  return null; }
                ...
                if ((e.getIPAddress().equals(confIPv4))  &&
                    ...
                    case jdemo.jdemo_ip:
                            ...
                            ConfObject c =  e.getIPAddress();
                            //new ConfIPv4(e.ip);
                    case jdemo.jdemo_hwaddr:
                        return new ConfBuf(e.getHWAddress());
                    case jdemo.jdemo_permanent:
                        return new ConfBool(e.getPermanent());
                    case jdemo.jdemo_published:
                        return new ConfBool(e.getPublished());
                    default:
                        return  null;
                    }
                }
