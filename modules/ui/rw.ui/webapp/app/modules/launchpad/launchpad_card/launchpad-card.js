  ...
  .directive('fleetCard', function($state, $stateParams) {
    return {
      ...
      controller: function($timeout, $interval, $scope, $rootScope, $element) {
        ...
        //   if (rw.getSearchParams(window.location).api_server) {
        //     self.fleet.started = true;
        //   }
        //   self.apiServer = rw.getSearchParams(window.location).api_server;
        //   self.isNoisy = false;
        ...
        //     var params = rw.getSearchParams(window.location);
...
.directive('launchpadFleetCardParams', function() {
  return {
    ...
    controller: function($scope, $stateParams, $timeout, $interval, $rootScope) {
      ...
      var self = this;
      var apiServer = rw.getSearchParams(window.location).api_server;
