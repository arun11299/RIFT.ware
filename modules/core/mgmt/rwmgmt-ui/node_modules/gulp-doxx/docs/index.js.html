      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="index.js.html">/Volumes/hdd/projects/gulp-doxx/index.js</a></li>
            <li><a href="README.md.html">/Volumes/hdd/projects/gulp-doxx/README.md</a></li>
          </ul>
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#exports"><i class="alert alert-info"></i><span>exports</span></a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                <td>[opts.title=No</td>
                <td>String</td>
                <td>title] - application title</td>
              </tr>
              <tr>
                <td>[opts.targetExtension=html]</td>
                <td>String</td>
                <td>- result files extension </td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>gulp-doxx plugin</p><p><em>Example</em></p><pre><code> var gulp = require(&#39;gulp&#39;),
 ...
 gulp.task(&#39;docs&#39;, function() {
   ...
   gulp.src(&#39;*.js&#39;)
     ...
     .pipe(gulp.dest(&#39;docs&#39;));
          ...
          <pre><code class="language-javascript">module.exports = function gulpDoxx(opts) {
  var opts = opts || {},
      allFiles = [],
      allSymbols = [];
