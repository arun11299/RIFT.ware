  ...
  angular.module('webui.header',['core'])
    .directive('webuiHeader',function(){
        return{
            restrict:'AE',
            templateUrl:'integration/_components/_header/header.html',
            link: function(scope,element,attrs){

            },
            controller:function($scope,$state,$rootScope,$interval,navData){
