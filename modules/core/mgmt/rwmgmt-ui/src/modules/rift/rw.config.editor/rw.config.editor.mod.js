...
(function(window, angular){
  ...
  angular.module('configEditor', ['rwHelpers'])
    ...
    .directive('configEditor', function(configFactory) {
      ...
      return {
        restrict: 'E',
        templateUrl:(rw.search_params.tmpl_url || 'modules/views/') + 'editor.html',
    ...
    .directive('configTree', function(RecursionHelper) {
      ...
      return {
        restrict: 'E',
        templateUrl:(rw.search_params.tmpl_url || 'modules/views/') +'tree.html',
        controller : controller,
        replace: true,
        scope: {
          item : '=',
    ...
    .directive('configDetails', function() {
      ...
      return {
        restrict: 'E',
        templateUrl:(rw.search_params.tmpl_url || 'modules/views/') + 'details.html',
        controller : controller,
        replace: true,
        scope: {
          item : '='
  ...
  var configUrl = '/test/data/api_running_colony.json';
  var yangUrl = '/test/data/model_config_rw-composite.json';
  angular.module('configEditor')
    .factory('configFactory', function() {
      return {
        get: function() {
          return $.when(
            rw.api.get(configUrl, 'application/vnd.yang.collection+json'),
            rw.api.json(yangUrl)
          );
        }
      };
