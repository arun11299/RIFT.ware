angular.module('trafsim')
  .factory('trafsimFactory', ['radio', '$timeout' , function(radio, $timeout) {
    ...
    return {
      attached: function () {
        ...
        rw.api.get('/api/running/colony?select=trafsim-service/name', 'application/vnd.yang.collection+json').done(function(data) {
          $timeout(function() {
      ...
      loadConfig: function (data) {
        ...
        appChannel.trigger("trafsim-update-config");
      },
      ...
      loadTimers: function (trafsim, timers) {
        ...
        appChannel.trigger("trafsim-update");
      },
