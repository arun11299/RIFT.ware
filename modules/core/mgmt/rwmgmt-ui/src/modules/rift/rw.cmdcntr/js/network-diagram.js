...
module.exports = (function(window, angular) {
  ...
  rw.TopologyLayout = function() {
    //  trafgen, load bal, other
    this.grid = [];
    this.dim = {
      yMargin0 : 20,
      xMargin : [30, 500, 500, 500],
      yMargin : 10,
      hTitle: 35,
      width : 250,
      curveRadius : 4,
  ...
  rw.TopologyLayout.prototype.x = function(o) {
    return o.x;
  };

  rw.TopologyLayout.prototype.y = function(o) {
    return o.y;
  };

  rw.TopologyLayout.prototype.w = function(o) {
    return o.w;
  };

  rw.TopologyLayout.prototype.h = function(o) {
    return o.h;
  };

  rw.TopologyLayout.prototype.layoutTitledPanel = function(o, colNdx, bodyHeight, bodyWidth) {
  ...
  rw.TopologyLayout.prototype.colIndex = function(service, services) {
    // RIFT-4304
  ...
  rw.TopologyLayout.prototype.appendTitledPanel = function(gxServices) {
    var s = gxServices
      .append("rect")
  ...
  rw.TopologyLayout.prototype.appendTitle = function(gxServices, onClick) {
  ...
  rw.TopologyLayout.prototype.appendIfaces = function(gxServices, layoutService,
                                                   layoutIface) {
    var self = this;
    this.connectors = {};
  ...
  rw.TopologyLayout.prototype.connectorStore = {};
  rw.TopologyLayout.prototype.connectorHandleFaceRight = function(iface, index) {
    if(this.connectorStore.hasOwnProperty(iface['@networkId'])) {
      this.connectorStore[iface['@networkId']] ++;
    } else {
      this.connectorStore[iface['@networkId']] = 1;
    }
    if (iface.parent.x <= this.dim.xMargin[0]) {
      return true;
    }
    if(this.connectorStore[iface['@networkId']] > 1) {
      return false;
    } else {
      return true;
    }
  ...
  rw.TopologyLayout.prototype.appendConnectorHandles = function(gxIfaces) {
    var self = this;
    ...
    gxConnectorHandle
      .append("path")
      .attr("d", function(iface, index) {
        iface.faceRight = self.connectorHandleFaceRight.call(self, iface, index);
  ...
  rw.TopologyLayout.prototype.buildSelectBox = function(w, h, dashLen) {
  ...
  rw.TopologyLayout.prototype.appendConnectors = function(gxDiagram) {
    var self = this;
