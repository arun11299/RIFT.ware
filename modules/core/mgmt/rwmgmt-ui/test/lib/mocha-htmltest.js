 ...
 * 
 * Modified by Douglas Hubler to support iframes that
 * are themselves mocha scripts unlike polymer elements
 */

(function() {
  var thisFile = 'mocha-htmltest.js';
  var base = '';
  ...
  var listener = function(event) {
    if (event.data === 'ok') {
      ...
      iframe.style.cssText = 'position: relative, left: 0em; width:768px; height: 1024px';
      iframe = null;
