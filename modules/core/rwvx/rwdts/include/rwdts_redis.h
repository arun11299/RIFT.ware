...
#define rwdts_redis_get_key_value(inst, db_num, key, key_len, cb, ud)\
  rwdts_redis_cmd(inst, db_num, (char *)"GET", key, key_len, NULL, 0, cb, ud);
...
#define rwdts_redis_get_hash_key_value(inst, db_num, key, key_len, cb, ud)\
  rwdts_redis_hash_cmd(inst, db_num, (char *)"HVALS", key, key_len, NULL, 0,\
                       cb, ud);

#define rwdts_redis_get_hash_key_sernum_value(inst, db_num, key, key_len, cb, ud)\
    rwdts_redis_hash_cmd(inst, db_num, (char *)"HGETALL", key, key_len, NULL, 0,\
                         cb, ud);
...
#define rwdts_redis_hash_exist_key_value(inst, db_num, key, key_len, cb, ud)\
  rwdts_redis_cmd(inst, db_num, (char *)"EXISTS", key, key_len, NULL, 0,\
                       cb, ud);
