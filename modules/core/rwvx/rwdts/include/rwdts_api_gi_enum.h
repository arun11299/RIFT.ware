...
typedef enum _RWDtsFlag {
  ...
  /* RWDtsFlags */
  RWDTS_FLAG_FILE_DATASTORE = (1<<7),
  RWDTS_FLAG_INTERNAL_REG   = (1<<8), /* This is used for internal DTS operation */
  RWDTS_FLAG_DELTA_READY    = (1<<9),
  RWDTS_FLAG_SUBOBJECT      = (1<<10),
  RWDTS_FLAG_DEPTH_FULL     = (1<<11),
  RWDTS_FLAG_DEPTH_OBJECT   = (1<<12),
  RWDTS_FLAG_DEPTH_LISTS    = (1<<13),
  RWDTS_FLAG_DEPTH_ONE      = (1<<14),
  RWDTS_FLAG_NO_PREP_READ   = (1<<15),
  RWDTS_FLAG_SUBSCRIBER     = (1<<17),
  RWDTS_FLAG_PUBLISHER      = (1<<18),
  RWDTS_FLAG_DATASTORE      = (1<<19),
  RWDTS_FLAG_ANYCAST        = (1<<20),
