                                       ...
                                       char *hostname, uint16_t port, void *callbkfn, void *callbk_data)
{
  ...
  rwdts_kv_db_trans_t *trans_block = RW_MALLOC(sizeof(rwdts_kv_db_trans_t));
  ...
  rwdts_kv_db_init_info *init_info = RW_MALLOC(sizeof(rwdts_kv_db_init_info));
  RW_ASSERT(init_info);
...
void
rwdts_kv_redis_set_api(void *instance, int db_num, char *key, int key_len,
...
void
rwdts_kv_redis_del_api(void *instance, int db_num, char *key, int key_len,
                       void *callbkfn, void *callbk_data)
{
  rwdts_kv_db_trans_t *trans_block = RW_MALLOC(sizeof(rwdts_kv_db_trans_t));
...
void rwdts_kv_redis_load_set_script(rwdts_kv_handle_t *handle, const char *filename)
{
  rwdts_kv_db_trans_t *trans_block = RW_MALLOC(sizeof(rwdts_kv_db_trans_t));
...
void rwdts_kv_redis_load_del_script(rwdts_kv_handle_t *handle, const char *filename)
{
  rwdts_kv_db_trans_t *trans_block = RW_MALLOC(sizeof(rwdts_kv_db_trans_t));
...
void rwdts_kv_redis_load_get_all_script(rwdts_kv_handle_t *handle, const char *filename)
{
  rwdts_kv_db_trans_t *trans_block = RW_MALLOC(sizeof(rwdts_kv_db_trans_t));
...
void rwdts_kv_redis_load_del_shard_script(rwdts_kv_handle_t *handle, const char *filename)
{
  rwdts_kv_db_trans_t *trans_block = RW_MALLOC(sizeof(rwdts_kv_db_trans_t));
...
void rwdts_kv_redis_load_set_pend_script(rwdts_kv_handle_t *handle, const char *filename)
{
  rwdts_kv_db_trans_t *trans_block = RW_MALLOC(sizeof(rwdts_kv_db_trans_t));
...
void rwdts_kv_redis_load_set_pend_commit_script(rwdts_kv_handle_t *handle, const char *filename)
{
  rwdts_kv_db_trans_t *trans_block = RW_MALLOC(sizeof(rwdts_kv_db_trans_t));
...
void rwdts_kv_redis_load_set_pend_abort_script(rwdts_kv_handle_t *handle, const char *filename)
{
  rwdts_kv_db_trans_t *trans_block = RW_MALLOC(sizeof(rwdts_kv_db_trans_t));
...
void rwdts_kv_redis_load_del_pend_script(rwdts_kv_handle_t *handle, const char *filename)
{
  rwdts_kv_db_trans_t *trans_block = RW_MALLOC(sizeof(rwdts_kv_db_trans_t));
...
void rwdts_kv_redis_load_del_pend_commit_script(rwdts_kv_handle_t *handle, const char *filename)
{
  rwdts_kv_db_trans_t *trans_block = RW_MALLOC(sizeof(rwdts_kv_db_trans_t));
...
void rwdts_kv_redis_load_del_pend_abort_script(rwdts_kv_handle_t *handle, const char *filename)
{
  rwdts_kv_db_trans_t *trans_block = RW_MALLOC(sizeof(rwdts_kv_db_trans_t));
                                                                 ...
                                                                 void *userdata)
{
  ...
  if (!trans_block->num_nodes) {
    ...
    if (trans_block->u.conn_callbkfn) {
      trans_block->u.conn_callbkfn(trans_block->callbk_data);
    }
    RW_FREE(trans_block);
  }
  return RWDTS_REDIS_REPLY_DONE;
...
void rwdts_kv_redis_init_cback_fn(rwdts_redis_db_init_info *db_info)
{
  ...
  if (RWDTS_REDIS_DB_DOWN == RWDTS_REDIS_DB_STATUS(db_info)) {
   ...
   rwdts_kv_redis_load_set_script(trans_block->handle, set_file_path);
   rwdts_kv_redis_load_del_script(trans_block->handle, del_file_path);
   rwdts_kv_redis_load_get_all_script(trans_block->handle, get_file_path);
   rwdts_kv_redis_load_del_shard_script(trans_block->handle, del_shard_file_path);
   rwdts_kv_redis_load_set_pend_script(trans_block->handle, set_pend_file_path);
   rwdts_kv_redis_load_set_pend_commit_script(trans_block->handle, set_pend_cfile_path);
   rwdts_kv_redis_load_set_pend_abort_script(trans_block->handle, set_pend_afile_path);
   rwdts_kv_redis_load_del_pend_script(trans_block->handle, del_pend_file_path);
   rwdts_kv_redis_load_del_pend_commit_script(trans_block->handle, del_pend_cfile_path);
   rwdts_kv_redis_load_del_pend_abort_script(trans_block->handle, del_pend_afile_path);
