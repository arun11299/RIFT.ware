...
rw.list:
	...
	@echo '                              			  (results in ${top}/.artifacts/coverage)'
	@echo '    make rw.fix_perms         			- Fix root ownership in .install'
...
rw.cmake:
	...
	env RIFT_ROOT=$(TOP_SRC_PATH) python3 rift_env.py
